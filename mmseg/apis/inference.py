...
def show_cell_pyplot(model: BaseSegmentor,
                       img: Union[str, np.ndarray],
                       result: SegDataSample,
                       opacity: float = 0.5,
                       title: str = '',
                       ...
                       out_file=None,
                       ogrannel=None):
    """Visualize the segmentation results on the image for organnels.
    ...
    Args:
        ...
        save_dir (str, optional): Save file dir for all storage backends.
            If it is None, the backend storage will not save any data.
        out_file (str, optional): Path to output file. Default to None.
        organnel: one of ['Chloroplast', 'Mitochondria', 'Vacuole', 'Nucleus']  show special color for each organnel
    Returns:
        np.ndarray: the drawn image which channel is RGB.
    """
    if hasattr(model, 'module'):
    ...
    organnels = ['background', 'Chloroplast', 'Mitochondria', 'Vacuole', 'Nucleus']
    # [R, G, B] -> [B G R]
    if ogrannel=='Chloroplast':
        palette = [[255, 255, 255], [153, 221, 174], [255, 255, 255], [255, 255, 255], [255, 255, 255]]
    elif ogrannel=='Mitochondria':
        palette = [[255, 255, 255], [255, 255, 255], [173, 205, 14], [255, 255, 255], [255, 255, 255]]    
    elif ogrannel=='Vacuole':
        palette = [[255, 255, 255], [255, 255, 255], [255, 255, 255], [39, 137, 238], [255, 255, 255]]
    elif ogrannel=='Mitochondria':
        palette = [[255, 255, 255], [255, 255, 255], [255, 255, 255], [255, 255, 255], [150, 97, 244]]
    elif ogrannel == None or organnel == 'all':
        # palette = [[128, 128, 128], [221, 153, 174], [205, 173, 14], [137, 39,238], [97, 150,244]]
        palette = [[128, 128, 128], [153, 221, 174], [173, 205, 14], [39, 137,238], [150, 97,244]]
